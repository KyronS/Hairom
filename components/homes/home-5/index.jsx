...
export default function Home5({ onePage = true, dark = false }) {
  return (
    <>
      <section
              ...
              <div>
                <div className="wow linesAnimIn" data-splitting="lines">
                  ...
                  <div className="text-gray mb-30 mb-sm-20">
                    <p className="mb-0">
                      Welcome to Hairom—where every cut, loc, and style is a celebration of YOU.

                      Born and bred in Trinidad & Tobago, we’re more than just a barbershop and loctician salon—we’re your personal style squad. Whether you’re chilling at home, prepping for Carnival, or just need a sharp fade before a big meeting, we come to you with top-tier grooming, no traffic stress required.

                      A fresh cut isn’t just about looking good—it’s about walking into the room like you own the place. That’s why our tagline isn’t just words; it’s a promise:
                      "Crown Adjusted Successfully."
                      
                      Founded by Moriah Howell-Paul in 2015, Hairom started with a simple idea: great hair care should be easy, natural, and for everybody. Whether you’re a corporate boss, a fete-loving soca head, or a pickney with big personality, we’ve got you covered—literally.

                      Need Us? Book a visit or call us to your door. Either way, you’re leaving fresher than a sea breeze in Maracas.
          ...
          <div className="row mb-70 mb-sm-50">
            <div className="col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center">
              ...
              <div className="text-gray">
                At Hairom, every cut, loc, and style tells a story. 
                Scroll through our gallery of fresh transformations. From razor-sharp tapers to intricate loc designs and kids’ first big chops.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row mb-70 mb-sm-50">
            <div className="col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center">
              ...
              <div className="text-gray">
                <p>Need a Crown Adjustment ASAP?</p>
                Hit us up for a house call or salon visit because great hair shouldn’t wait.
              </div>
            </div>
          </div>
        </div>
