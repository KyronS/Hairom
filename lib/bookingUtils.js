...
export const SERVICES = [
  { id: 1, name: "Haircut",            price: 25, duration: 45, category: "Haircuts" },
  { id: 2, name: "Shape Up / Edge Up", price: 15, duration: 30, category: "Haircuts" },
  { id: 3, name: "Loc Retwist",        price: 60, duration: 90, category: "Locs"     },
  { id: 4, name: "Loc Style",          price: 45, duration: 60, category: "Locs"     },
  { id: 5, name: "Natural Style",      price: 50, duration: 60, category: "Natural"  },
  { id: 6, name: "Wash & Style",       price: 40, duration: 60, category: "Natural"  },
];
